...
class CustomSelection(BaseSelection):
	"""A selector based off a custom, user-defined function.
	...
	should be an example. If the function operates on feature values, each column
	should be a feature value for the example (like a standard data matrix for
	machine learning). If the function operates on similarities, e.g a graph-based
	function like facility location, the columns should be similarities with each
	example in the ground set and the number of columns should be equal to the size
	of the ground set.
	...
	func : function
		The set function to that this selector should wrap.
	...
	def __init__(self, n_samples, func, initial_subset=None, 
